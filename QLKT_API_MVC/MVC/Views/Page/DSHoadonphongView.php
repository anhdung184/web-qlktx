...
<form method="post" action="http://localhost/QLKT_API_MVC/DSHoadonphong/Timkiem">
					...
					<div class="content__duoi">
						<div class="content__duoi-menu">
							<ul class="content__duoi-list">
								...
								<li class="content__duoi-item"><a href="http://localhost/QLKT_API_MVC/ThemHoadonphong" class="content__duoi-link"><i class="content__duoi-link-icon icon__add fa-solid fa-circle-plus"></i>Thanh toán tiền phòng</a></li>
							</ul>
						</div>
										...
										<tr>
											...
											<!-- <a style="text-decoration: none;" href=""  <?php if($row['Tinhtranghd']=="Đã thanh toán") echo 'hidden' ?>>
											 ...
											 <td>
												...
												<a style="text-decoration: none;" href="http://localhost/QLKT_API_MVC/DSHoadonphong/Xoahoadonphong/<?php echo $row['Mahdp'] ?>">
